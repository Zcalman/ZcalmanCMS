...
do 
{
	$sql = mysql_query("SELECT id FROM sections_news WHERE slug = '{$slug}' AND section_id = {$section_id} AND id != {$id}");
...
targetDiv.innerHTML = "<?PHP host(); echo $section_slug . "/article/" . $slug; ?>";