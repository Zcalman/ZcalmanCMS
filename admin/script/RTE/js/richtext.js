...
function rteMouseDownMenuContents() {
    if (this.innerHTML == "Gigantisk rubrik") {
        document.getElementById(rteName).contentWindow.document.execCommand("formatblock", false, "<h1>");
        document.getElementById("format1").innerHTML = "Gigantisk rubrik";
    } else if (this.innerHTML == "Stor rubrik") {
        document.getElementById(rteName).contentWindow.document.execCommand("formatblock", false, "<h2>");
        document.getElementById("format1").innerHTML = "Stor rubrik";
    } else if (this.innerHTML == "Mellan rubrik") {
        document.getElementById(rteName).contentWindow.document.execCommand("formatblock", false, "<h3>");
        document.getElementById("format1").innerHTML = "Mellan rubrik";
    } else if (this.innerHTML == "Liten rubrik") {
        document.getElementById(rteName).contentWindow.document.execCommand("formatblock", false, "<h4>");
        document.getElementById("format1").innerHTML = "Liten rubrik";
    ...
    } else if (this.innerHTML == "Normal text") {
        document.getElementById(rteName).contentWindow.document.execCommand("formatblock", false, "<p>");
        document.getElementById("format1").innerHTML = "Normal text";
...
function rteBtnInsertImage() { /* klicka */
    window.open(rteHTMLPathInsertImage, "blank", "toolbar=no,width=825,height=620");
};

function rteBtnInsertDoc() { /* klicka */
    window.open(rteHTMLPathInsertDoc, "blank", "toolbar=no,width=825,height=620");
};
...
function pasteHtmlAtCaret(html) {
    var sel, range;
	var iframeObj = document.getElementById(rteName);
    if (iframeObj.contentWindow.window.getSelection) {
        // IE9 and non-IE
        sel = iframeObj.contentWindow.window.getSelection();
        if (sel.getRangeAt && sel.rangeCount) {
            ...
            var el = iframeObj.contentWindow.document.createElement("div");
            el.innerHTML = html;
            var frag = iframeObj.contentWindow.document.createDocumentFragment(), node, lastNode;
    ...
    } else if (iframeObj.contentWindow.document.selection && iframeObj.contentWindow.document.selection.type != "Control") {
        // IE < 9
        iframeObj.contentWindow.document.selection.createRange().pasteHTML(html);
    }
};
...
function rteAbout() {
    msg = window.open("", "msg", "height=110,width=320");
    msg.document.write("<style>");
    msg.document.write("body, td {");
    msg.document.write("background-color:#adf;");
    ...
    msg.document.write("</tr>");
    msg.document.write("<tr>");
    msg.document.write("<td colspan=\"2\" align=\"center\">Some smaller modifications made by Zcalman</td>");
    msg.document.write("</tr>");
    ...
    if (document.getElementById("rte_code_mode").className == "rtebtn9") {
        ...
        while (previous_tagName != "HTML") {
            ...
            if (previous_tagName == "H1") {
                document.getElementById("format1").innerHTML = "Giganstisk rubrik";
            }
...
function menuBuilder() {
    ...
    if (rteDoc) {
        document.getElementById("insertdoc").style.display = "";
    } else {
        document.getElementById("insertdoc").style.display = "none";
    }
    if (rteRemoveFormat) {
    ...
    if (!rteFormat && !rteFontFace && !rteFontSize && !rteBold && !rteItalic && !rteUnderline && !rteStrikeThrough && !rteLeftAlign && !rteCenterAlign && !rteRightAlign && !rteFullAlign && !rteHorizontalRule && !rteSuperscript && !rteSubscript) {
        document.getElementById("tb1").style.display = "none";
    }
    if (!rteLink && !rteUnlink && !rteImages && !rteRemoveFormat && !rteTables && !rteOrderedList && !rteUnorderedList && !rteIndent && !rteOutdent && !rteUndo && !rteRedo && !rteCutCopyPaste) {
        document.getElementById("tb2").style.display = "none";
    }
    ...
    if (!rtePrint && !rteSelectAll && !rteSpellCheck) {
...
function initRTE(rtePreloadContent, rteCSS) {
    if (!document.designMode) {
        document.write('<textarea class="codefield" id="' + rteFormName + '" name="' + rteFormName + '" onkeyup="javscript: rteFormHandler(); "  style="width:' + rteWidth + ';height:' + rteHeight + ';"></textarea>');
        //document.write('<textarea class="codefield" id="' + rteFormName + '" name="' + rteFormName + '" style="width:' + rteWidth + ';height:' + rteHeight + ';"></textarea>');
    } else {
        ...
        document.write('<table id="RTEmain" style="width:' + rteWidth + ';" cellpadding="0" cellspacing="0">');
        document.write('  <tr>');
        document.write('    <td id="RTEmenu">');
        document.write('	<table class="toolsmenu" cellpadding="0" cellspacing="0" id="tb1" onmousedown="return false;">');
        document.write('      <tr>');
        document.write('        <td class="rtebg" id="rtesep1"></td>');
        document.write('        <div id="tb2" style="width:0px; height:0px;"></td>');
        document.write('        <div id="tb3" style="width:0px; height:0px;"></td>');
        document.write('        <td id="rteformat">');
        document.write('		<table cellpadding="0" cellspacing="0" id="format4" bgcolor="#EAEAEA" title="Style">');
        document.write('          <tr>');
        document.write('            <td nowrap><div unselectable="on" id="format1" class="rtedropdown1" style="width:80px;font-family:arial;font-size:11px;color:#000000;margin-left:10px;background-color:#FFF;">Normal text</div></td>');
        ...
        document.write('			<div unselectable="on" id="formatblock" style="font-size:24px; font-family:arial;color:#000000;font-weight:bold;padding:5px;" nowrap>Gigantisk rubrik</div>');
        document.write('			<div unselectable="on" id="formatblock" style="font-size:18px; font-family:arial;color:#000000;font-weight:bold;padding:5px;" nowrap>Stor rubrik</div>');
        document.write('			<div unselectable="on" id="formatblock" style="font-size:16px; font-family:arial;color:#000000;font-weight:bold;padding:5px;" nowrap>Mellan rubrik</div>');
        document.write('			<div unselectable="on" id="formatblock" style="font-size:14px; font-family:arial;color:#000000;font-weight:bold;padding:5px;" nowrap>Liten rubrik</div>');
        ...
        document.write('			<div unselectable="on" id="formatblock" style="font-size:12px; font-family:arial;color:#000000;font-weight:bold;padding:5px;" nowrap>Normal text</div>');
        document.write('		</div>');
        document.write('        </td>');
        ...
        document.write('        <td class="rtebg" title="Lägg till bild"><div id="insertimage" class="rtebtn1"><a href="javascript:rteBtnInsertImage();" style="cursor:default;"><img src="' + rteImagePath + 'insertimage.gif" border="0"></a></div></td>');
		document.write('        <td class="rtebg" title="Lägg till dokumentlänk"><div id="insertdoc" class="rtebtn1"><a href="javascript:rteBtnInsertDoc();" style="cursor:default;"><img src="' + rteImagePath + 'insertdoc.gif" border="0"></a></div></td>');
        ...
        document.write('        <td class="rtebg" id="rtesep9"><img src="' + rteImagePath + 'seperator.gif"></td>');
        ...
        document.write('        <td class="rtebg" title="About Free Rich Text Editor"><div id="aboutrte" class="rtebtn1"><a href="javascript:rteAbout();" style="cursor:default;"><img src="' + rteImagePath + 'about.gif" border="0"></a></div></td>');
        document.write('        <td width="100%"></td>');
        document.write('	  </tr>');
        document.write('    </table>');
        document.write('    </td>');
        document.write('  <tr>');
        document.write('    <td id="textfield">');
        document.write('		<iframe name="' + rteName + '" onkeyup="javscript: rteFormHandler();"  id="' + rteName + '" style="width:100%; height:' + rteHeight + '; background-color:#FFFFFF;" frameborder="0"></iframe>');
        // Fix för att hindra hopp i HTML-läge 
		//document.write('		<textarea class="codefield" name="' + rteFormName + '" id="' + rteFormName + '" onkeyup="javscript: rteFormHandler();" style="display:none;width:' + rteWidth + '; height:' + rteHeight + ';"></textarea>');
        document.write('		<textarea class="codefield" name="' + rteFormName + '" id="' + rteFormName + '" style="display:none;width:' + rteWidth + '; height:' + rteHeight + ';"></textarea>');
        ...
        document.write('  </tr>');
        document.write('  <tr>');
        document.write('    <td class="RTEfooter">');
        ...
        if (rteCodeMode) {
            document.write('							<td style="color:#000000; font-family:arial; font-size:11px;"><div class="rtebtn6" id="rte_code_mode" onclick="rteModeType(\'rte_code_mode\');"><img src="' + rteImagePath + 'code.gif">&nbsp;HTML-kod</div></td>');
        } else {
            document.write('							<td style="display:none;color:#000000; font-family:arial; font-size:11px;"><div class="rtebtn6" id="rte_code_mode"><img src="' + rteImagePath + 'code.gif">&nbsp;HTML-kod</div></td>');
        }
        if (rtePreviewMode) {
            document.write('							<td style="color:#000000; font-family:arial; font-size:11px;"><div class="rtebtn6" id="rte_preview_mode" onclick="rteModeType(\'rte_preview_mode\');"><img src="' + rteImagePath + 'preview.gif">&nbsp;Förhandsgranskning</div></td>');
        } else {
            document.write('							<td style="display:none;color:#000000; font-family:arial; font-size:11px;"><div class="rtebtn6" id="rte_preview_mode"><img src="' + rteImagePath + 'preview.gif">&nbsp;Förhandsgranskning</div></td>');
        }
        document.write('						</tr>');
        document.write('					</table>');
        document.write('				</td>');
