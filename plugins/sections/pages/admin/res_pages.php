...
if($section_id != 0)
{
	$pageNav = new PageNav(15, 25, $pagenr, "sections_pages", "goto", HOST . "admin/plugin/sections/sectionrespages/{$section_id}/", "/{$afterlink}", "WHERE extrawide = 1 AND section_id = {$section_id} ORDER BY {$order}");
	$works = new Table(3, "ID|Rubrik|Länk", "55|266|470", "clickSectionResPage");
	...
	?>
	<div class="pagetitle">
        Resultatsidor i sektionen <?PHP echo sections_getSectionName($section_id); ?>
        <?PHP
	...
	<div class="searchOrder" style="margin-bottom:20px;">
		<div class="dropbox">
			<select name="orderlist" class="dropdown" id="order-respages-list">
	...
	<div class="button right" onclick='javascript: goto(host + "admin/plugin/sections/sectionrespage/<?PHP echo $section_id; ?>");'>
		Skapa ny resultatsida
	</div>
	<?PHP
	$works->printTable();
	echo "\n";
...
else
{
    ...
    <div class="description" style="margin-bottom:20px;">
    	Eftersom du kan hantera resultatsidor i flera olika sektioner måste du välja den sektion <br />
        som du vill hantera resultatsidorna för.
    </div>
    <div class="dropbox">
    ...
    <input type="hidden" value="sectionrespages" id="select_section_page" />
